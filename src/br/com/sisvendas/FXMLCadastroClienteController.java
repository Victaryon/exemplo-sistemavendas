...
import static br.com.sisvendas.ClassePrincipal.mainLayout;
...
public class FXMLCadastroClienteController implements Initializable {
    ...
    @FXML
    void btnClienteFechar(ActionEvent event) throws IOException {
    ...
    @FXML
    private void tfClienteTelefone(KeyEvent event) {
